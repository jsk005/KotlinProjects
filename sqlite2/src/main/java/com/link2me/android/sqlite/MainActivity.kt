...
// SQLite 샘플과 동일한 코드인데, ListViewAdapter 처리를 InnerClass 에서 별도 Class 로 분리하고 filer 부분 수정
...
//    inner class ListViewAdapter(context: Context, items: MutableList<Address_Item>) : BaseAdapter() {
